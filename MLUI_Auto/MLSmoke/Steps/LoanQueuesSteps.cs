...
namespace MLAutoFramework
{
    ...
    public class LoanQueues : TestBase
    {
        ...
        public LoanQueues(IWebDriver _driver, ExtentTest test)
        {
        ...
        {
            _driver.WaitForElementPresentAndEnabled(CustomAppQueuesPage.Test_ConditionSet_Lnk, 60);
        ...
        {
            _driver.WaitForElementPresent(CustomAppQueuesPage.Filters_Lnk, 5);
        ...
        public void WhenUserAddedACondition()
        {
            ...
            main_window = WindowHelper.switchToChildWindow(_driver);
            _driver.WaitForPageLoad();
            _driver.WaitForElementPresentAndEnabled(CustomAppQueuesPage.Add_Condition_Txt, 60);
            ...
            _driver.WaitForPageLoad();
            _driver.WaitForElementPresentAndEnabled(CustomAppQueuesPage.Add_Condition_Header_Lbl, 60);
            _driver.FindElement(CustomAppQueuesPage.Add_Condition_Header_Lbl).Click();
            _driver.WaitForPageLoad();
            _driver.FindElement(CustomAppQueuesPage.Add_Condition_Ddn3).Click();
        ...
        public void WhenUserClickedOnIconUsersWithThisAppInTheirQueue()
        {
            ...
            if (_driver.FindElements(HomePage.Already_Assigned_Status_Txt).Count > 0)
            {
            ...
            {
                string[] str = officersName.Split(',');
                if (_driver.FindElement(HomePage.Assigned_Status_Txt).GetText().Contains(str[0]))
                {
                    _driver.FindElement(HomePage.App_Assignment_Close_Btn).Click();
                }
            }
        ...
        {
            _driver.WaitForElementPresentAndEnabled(CustomAppQueuesPage.TestCondition_Message_Txt, 60);
        ...
        public void ThenMessageShouldBeDisplayedAsApplicationAddedToQueuesWithTheOfficersName()
        {
            ...
            {
                Assert.IsTrue(_driver.FindElement(HomePage.Assigned_Status_Txt).GetText().Contains(str[0]) && _driver.FindElement(HomePage.Assigned_Status_Txt).GetText().Contains(str[1]));
