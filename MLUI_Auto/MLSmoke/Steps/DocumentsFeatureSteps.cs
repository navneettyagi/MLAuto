...
{
    [Binding]
    public class DocumentsFeatureSteps : TestBase
    {
        ...
        public DocumentsFeatureSteps(IWebDriver _driver, ExtentTest test)
        {
        ...
        {
            _driver.WaitForElementPresentAndEnabled(HomePage.NewAPP_Focus, 80);
        ...
        {
            _driver.WaitForElementPresent(LoanPage.LetterDocs_Lnk, 3);
        ...
        {
            _driver.WaitForPageLoad();
            _driver.WaitForElementPresentAndEnabled(VELetterTemplatesPage.AttachDocument_Btn, 80);
            _driver.FindElement(VELetterTemplatesPage.AttachDocument_Btn).Click();
            main_window = WindowHelper.switchToChildWindow(_driver);
            _driver.isDialogPresent();
            _driver.WaitForPageLoad();
            _driver.WaitForElementPresent(UploadLoanDocumentPage.Title_Ddn, 5);
            //_driver.WaitForElementPresentAndEnabled(UploadLoanDocumentPage.Title_Ddn, 80);
            ...
            _driver.WaitForElementPresentAndEnabled(UploadLoanDocumentPage.Save_Btn, 80);
        ...
        {
            _driver.WaitForElementPresentAndEnabled(VELetterTemplatesPage.Display_Lnk, 80);
        ...
        public void VerifyPrintButton()
        {
            ...
            _driver.WaitForElementPresentAndEnabled(PrintPreviewPage.Print_Btn, 80);
            _driver.FindElement(PrintPreviewPage.Print_Btn).AssertElementPresent();
            _driver.WaitForElementPresentAndEnabled(PrintPreviewPage.Close_Btn, 80);
        ...
        public void AttachPdfDocument()
        {
            ...
            main_window = WindowHelper.switchToChildWindow(_driver);
            _driver.isDialogPresent();
            _driver.WaitForElementPresent(UploadLoanDocumentPage.Browse_Iframe, 5);
            _driver.SwitchTo().Frame(_driver.FindElement(UploadLoanDocumentPage.Browse_Iframe));
            _driver.FindElement(UploadLoanDocumentPage.Browse_Btn).UploadDocument(filePath5MB);
            Thread.Sleep(10000);
            test.Log(Status.Info, "PDF attahced of more than 4mb ");
        }
        ...
        public void VerifyPopUp()
        {
            ...
            _driver.WaitForPageLoad();
            _driver.SwitchTo().DefaultContent();
            _driver.WaitForElementPresentAndEnabled(UploadLoanDocumentPage.Close_Button, 80);
        ...
        {
            _driver.WaitForElementPresentAndEnabled(VELetterTemplatesPage.ShowConsumer_Lnk, 80);
        ...
        {
            _driver.WaitForElementPresent(VELetterTemplatesPage.RemoteDocUpload_Btn, 5);
            //_driver.WaitForElementPresentAndEnabled(VELetterTemplatesPage.RemoteDocUpload_Btn, 80);
            _driver.FindElement(VELetterTemplatesPage.RemoteDocUpload_Btn).Click();
            main_window = WindowHelper.switchToChildWindow(_driver);
            _driver.WaitForPageLoad();
            _driver.WaitForElementPresent(DocumentUploadLinkPage.GenerateLink_Lnk, 5);
            _driver.FindElement(DocumentUploadLinkPage.GenerateLink_Lnk).Click();
            _driver.WaitForElementPresent(DocumentUploadLinkPage.URL, 5);
            //_driver.WaitForElementPresentAndEnabled(DocumentUploadLinkPage.URL, 80);
        ...
        {
            _driver2.WaitForElementPresentAndEnabled(FileSharePage.SendDocument_Lnk, 80);
            _driver2.FindElement(FileSharePage.SendDocument_Lnk).Click();
            _driver2.WaitForElementPresentAndEnabled(FileSharePage.DocumentType_Ddn, 80);
            ...
            _driver2.WaitForPageLoad();
            Thread.Sleep(5000);
            _driver2.WaitForElementPresentAndEnabled(FileSharePage.SendDocument_Btn, 80);
        ...
        public void UploadFivePDFDocuments()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                _driver2.WaitForElementPresentAndEnabled(FileSharePage.SendDocument_Btn, 80);
                _driver2.FindElement(FileSharePage.SendDocument_Btn).Click();
                _driver2.WaitForElementPresent(FileSharePage.UploadDocument_Btn, 5);
        ...
        {
            _driver.WaitForElementPresentAndEnabled(VELetterTemplatesPage.UploadDocuments_TableItems_Arrow, 80);
        ...
        {
            Thread.Sleep(3000);
            _driver.WaitForElementPresent(HomePage.Setup_Focus, 5);
            //_driver.WaitForElementPresentAndEnabled(HomePage.Setup_Focus, 80);
            _driver.HoverAndClick(_driver.FindElement(HomePage.Setup_Focus), _driver.FindElement(HomePage.ConfigureSite_Focus));
            _driver.WaitForElementPresentAndEnabled(ConfigureSitePage.ModuleConfiguration_lnk, 80);
            _driver.FindElement(ConfigureSitePage.ModuleConfiguration_lnk).Click();
            Thread.Sleep(3000);
            _driver.WaitForElementPresentAndEnabled(ModuleConfigurationPage.Letter_Docs_Templates_lnk, 80);
            ...
            _driver.WaitForElementPresentAndEnabled(LetterAndTemplatesPage.Documents_Tab, 80);
        ...
        {
            _driver.WaitForElementPresentAndEnabled(LoanPage.LoanAppNumber, 80);
            _driver.FindElement(LoanPage.LoanAppNumber).GetText();
            _driver.WaitForElementPresentAndEnabled(LoanPage.Amount_Requested_Txt, 80);
            ...
            _driver.WaitForPageLoad();
            _driver.WaitForElementPresentAndEnabled(LoanPage.SSN_Txt, 80);
            ...
            _driver.WaitForElementPresentAndEnabled(LoanPage.Custom_Question_CheckBox, 80);
            _driver.FindElement(LoanPage.Custom_Question_CheckBox).Click();
            _driver.WaitForPageLoad();
            _driver.WaitForElementPresentAndEnabled(LoanPage.Custom_Question_Ddn_First, 80);
        ...
        public void AddPDF()
        {
            if (filesAdded.Equals(filesAddedStatus))
            {
                ...
                for (int i = 1; i <= 2; i++)
                {
                    _driver.WaitForElementPresentAndEnabled(LetterAndTemplatesPage.AddNew_Btn, 80);
                    _driver.FindElement(LetterAndTemplatesPage.AddNew_Btn).Click();
                    main_window = WindowHelper.switchToChildWindow(_driver);
                    _driver.WaitForElementPresentAndEnabled(AddPdfPage.PdfTitle_Txt, 80);
                    ...
                    Thread.Sleep(5000);
                    _driver.SwitchTo().DefaultContent();
                    _driver.WaitForElementPresentAndEnabled(AddPdfPage.AppType_VL_Chckbx, 80);
        ...
        public void CheckPDF()
        {
            _driver.WaitForElementPresent(LoanPage.LetterDocs_Lnk, 3);
            _driver.FindElement(LoanPage.LetterDocs_Lnk).Click();
            _driver.WaitForElementPresent(VELetterTemplatesPage.PdfMaster_Chckbx, 3);
            _driver.FindElement(VELetterTemplatesPage.PdfMaster_Chckbx).Click();
            _driver.WaitForElementPresentAndEnabled(VELetterTemplatesPage.DisplaySelected_Btn, 80);
        ...
        public void VerifyPDFsDisplayed()
        {
            ...
            _driver.WaitForElementPresentAndEnabled(PrintPreviewPage.AllDocuments_Ddn, 80);
        ...
        public void IncompletePDF()
        {
            main_window = WindowHelper.switchToChildWindow(_driver);
            _driver.SwitchTo().Frame(PrintPreviewPage.Frame);
            _driver.WaitForElementPresentAndEnabled(PrintPreviewPage.SaveAsIncomplete_Btn, 80);
        ...
        public void PDFMapper()
        {
            ...
            _driver.WaitForElementPresentAndEnabled(PDFMapperPage.Close_Btn, 80);
